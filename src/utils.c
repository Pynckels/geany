...
gchar *utils_replace_placeholder(const GeanyDocument *doc, const gchar *src, const gchar *needles)
{
	...
	if ( g_utf8_strchr(needles, -1, 'd') != NULL && strstr(haystack->str, "%d") ) g_string_append(errormsg, " %%d");
	if ( g_utf8_strchr(needles, -1, 'e') != NULL && strstr(haystack->str, "%e") ) g_string_append(errormsg, " %%e");
	if ( g_utf8_strchr(needles, -1, 'f') != NULL && strstr(haystack->str, "%f") ) g_string_append(errormsg, " %%f");
	if ( g_utf8_strchr(needles, -1, 'l') != NULL && strstr(haystack->str, "%l") ) g_string_append(errormsg, " %%l");
	if ( g_utf8_strchr(needles, -1, 'p') != NULL && strstr(haystack->str, "%p") ) g_string_append(errormsg, " %%p");
